...
public class Main {
    ...
    /*public static void main(String[] args) {
        ...
        grafo.agregarArco(1, 4, 2);
        grafo.agregarArco(2, 5, 7);
        grafo.agregarArco(3, 6, 6);
        grafo.agregarArco(6, 7, 9);
        ...
        System.out.println(grafo.cantidadArcos());
        grafo.borrarArco(6, 7);
        System.out.println("SE borra el arco 6,7");
        
        Iterator<Arco<Integer>> arcos2 = grafo.obtenerArcos();
        while(arcos2.hasNext()) {
        	Arco<Integer> arco = arcos2.next();
        	System.out.println(arco.getVerticeOrigen() + "--->" + arco.getVerticeDestino());
        }
        System.out.println(grafo.cantidadArcos());
        ...
        List<Integer> it = dfs.dfsForest();
        for(Integer i : it) {
        	System.out.print(i + "--");
        }
        System.out.println("\t");
        List<Integer> ti = bfs.bfsForest();
        for(Integer i : ti) {
        	System.out.print(i + "--");
        }
